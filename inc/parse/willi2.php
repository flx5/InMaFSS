       ...
       function parseTeacherHTML($html) {
               ...
               foreach($replacements as $repl) {
                    ...
                    foreach($vertretung as $v) {
                          ...
                          $note = substr($v[4],0,strrpos($v[4],'<'));      $note = substr($note,0,strrpos($note,'<'));
              ...
              foreach($grades as $grade) {
                       ...
                       $final['grades'][] = Array('reason'=>'', 'teacher'=>trim($name[1]), 'lesson'=>$lesson[1], 'stamp_update'=>$stamp_update, 'stamp_for'=>$stamp_for, 'addition'=>$addition);
              }
              ...
              foreach($rooms as $room) {
                       ...
                       $final['rooms'][] = Array('reason'=>'', 'teacher'=>trim($name[1]), 'lesson'=>$lesson[1], 'stamp_update'=>$stamp_update, 'stamp_for'=>$stamp_for, 'addition'=>$addition);
              }
              ...
              foreach($school as $event) {
                       ...
                       $final['school'][] = Array('teacher'=>'', 'reason'=>trim($reason[1]), 'lesson'=>$lesson[1], 'stamp_update'=>$stamp_update, 'stamp_for'=>$stamp_for, 'addition'=>$addition);
              }
              ...
              foreach($aufsicht as $item) {
                       ...
                       $final['aufsicht'][] = Array('lesson'=>'', 'reason'=>trim($place[1]), 'teacher'=>$teacher[1], 'stamp_update'=>$stamp_update, 'stamp_for'=>$stamp_for, 'addition'=>$addition);
              }
